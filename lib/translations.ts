export const translations = {
  header: {
    ...
    nav: {
      intro: { cs: "Úvod", en: "Intro" }, // New navigation item
      qualifications: { cs: "Kvalifikace", en: "Qualifications" },
      appraisals: { cs: "Odhady nemovitostí", en: "Property Appraisals" },
  ...
  introSection: {
    ...
    introQuestion: {
      ...
      en: "When will you need me?",
    },
    introPoints: [
      {
        cs: "Chcete prodat Vaši nemovitost bez realitní kanceláře?",
        en: "Do you want to sell your property without a real estate agency?",
      },
      {
        cs: "Řešíte dědictví, dotace, nebo chcete nějakou nemovitost koupit?",
        en: "Are you dealing with inheritance, subsidies, or do you want to buy a property?",
      },
      {
        cs: "Zajímá Vás, jakou hodnotu má Váš majetek?",
        en: "Are you interested in the value of your property?",
      },
    ],
  },
  services: {
    heading: {
      cs: "V oboru odhadů nemovitostí Vám mohu poskytnout tyto služby:",
    ...
    rentAmountOriginal: {
      ...
      description: {
        ...
        en: "Do you want to start renting out a property and don't know how much rent to set? Contact me and I will calculate the rent amount for the given property. Of course, the determination of the income value of the given property is also included.",
      },
    },
  },
  propertyAppraisals: {
    heading: { cs: "Odhady nemovitostí", en: "Property Appraisals" },
    subheading: { cs: "Ocením pro Vás tyto nemovitosti", en: "I will appraise the following properties for you" },
    land: {
      ...
      types: [
        ...
        },
        {
          ...
          en: "Other (i.e., forest land, water areas)",
        },
      ],
    },
    residential: {
      title: { cs: "Nemovitosti určené k bydlení", en: "Residential Properties" },
      types: [
        { cs: "Rodinné domy", en: "Family houses" },
        { cs: "Rekreační objekty – chaty, chalupy", en: "Recreational properties – cottages, chalets" },
        { cs: "Byty", en: "Apartments" },
      ],
    },
    commercial: {
  ...
  qualifications: {
    heading: { cs: "Kvalifikace", en: "Qualifications" },
    points: [
      {
        cs: "Diplom VŠ",
  ...
  contact: {
    ...
    name: { cs: "Ing. Natálie Jurdová", en: "Ing. Natálie Jurdová" },
    ic: { cs: "14325764 (IČ)", en: "14325764 (ID No.)" },
    phone: { cs: "+420 727 838 131", en: "+420 727 838 131" },
    email: { cs: "info@odhadyjurdova.cz", en: "info@odhadyjurdova.cz" },
    serviceArea: {
      cs: "Služby odhadce nemovitosti nabízím v kraji Vysočina a v Jihočeském kraji",
      en: "I offer real estate appraisal services in the Vysočina region and the South Bohemian region.",
    },
    ...
    form: {
      title: { cs: "Kontaktní formulář", en: "Contact Form" },
      nameSurname: { cs: "Jméno a příjmení", en: "Name and Surname" },
      phone: { cs: "Telefon", en: "Phone" },
      email: { cs: "Email", en: "Email" },
      propertyAddress: { cs: "Adresa nemovitosti", en: "Address of property" },
      subjectValuation: { cs: "Předmět ocenění nemovitosti", en: "Subject of property valuation" },
      ...
      subjectOptions: [
        ...
        { value: "land", cs: "Pozemek", en: "Land" },
        { value: "commercial-object", cs: "Komerční objekt", en: "Commercial property" },
        { value: "recreational-object", cs: "Rekreační objekt", en: "Recreational property" },
        { value: "other", cs: "Jiné", en: "Other" },
      ],
      purposeOptions: [
        { value: "inheritance", cs: "Dědictví", en: "Inheritance" },
        {
          value: "settlement",
          cs: "Vypořádání SJM/podílového spoluvlastnictví",
          en: "Settlement of joint property/co-ownership",
        },
        { value: "sale", cs: "Prodej", en: "Sale" },
        { value: "purchase", cs: "Koupě", en: "Purchase" },
        { value: "subsidies", cs: "Dotace", en: "Subsidies" },
        { value: "bank", cs: "Banka", en: "Bank" },
        { value: "other", cs: "Jiné", en: "Other" },
      ],
    },
  },
  footer: {
    nav: {
      intro: { cs: "Úvod", en: "Intro" },
      qualifications: { cs: "Kvalifikace", en: "Qualifications" },
      appraisals: { cs: "Odhady nemovitostí", en: "Property Appraisals" },
      contact: { cs: "Kontakt", en: "Contact" },
    },
    contactHeading: { cs: "Kontakt", en: "Contact" },
    instagram: { cs: "Instagram Profil", en: "Instagram Profile" },
    copyright: {
      cs: "© 2025 OdhadyJurdova.cz. Všechna práva vyhrazena.",
      en: "© 2025 OdhadyJurdova.cz. All rights reserved.",
    },
  },
}
